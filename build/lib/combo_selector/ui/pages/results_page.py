...
class ResultsPage(QFrame):
    ...
    def __init__(self, model=None, app_profile=None):
    ...
    def _apply_profile_settings(self) -> None:
        """Hide advanced result controls for the simplified user profile."""
        if getattr(self.app_profile, "allow_custom_results_settings", True):
            return

        self.minimum_performance_penalty_group.setVisible(False)
        self.vizualation_settings_group.setVisible(False)
        self.use_computed_btn.setEnabled(False)
