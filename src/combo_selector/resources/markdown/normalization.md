...
This step reduces the effect of differences in retention scale between conditions and allows all combinations to be compared within a common separation space.

The selected normalization is applied independently to each tested condition and only affects the processed data used for visualization and metric calculation, not the original imported values.
